...
public class WebViewActivity extends AppCompatActivity {
    ...
    String encVal;
    String vResponse;
    String numSeats,totalAmount,busNum;
        ...
        protected void onPostExecute(Void result) {
            ...
            class MyJavaScriptInterface {
                ...
                public void processHTML(String html) {
                    ...
                    /*intent.putExtra(AvenuesParams.ORDER_ID, getIntent().getStringExtra(AvenuesParams.ORDER_ID));
                    intent.putExtra(AvenuesParams.CURRENCY, "INR");
                    intent.putExtra(AvenuesParams.AMOUNT,getIntent().getStringExtra( AvenuesParams.AMOUNT));
                    intent.putExtra("num_seats",numSeats);
                    intent.putExtra("amount_total",totalAmount);
                    intent.putExtra("bus_num",busNum);
                    intent.putExtra("user_name",getIntent().getStringExtra("user_name"));
                    intent.putExtra("user_num", getIntent().getStringExtra("user_num"));
                    intent.putExtra("bus_id",getIntent().getStringExtra("bus_id"));*/
